...
void add_trains()
{
    ...
    FILE *fp=fopen("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\alltrains.dat","rb");
    if(fp==NULL)
    {
        fp=fopen("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\alltrains.dat","wb");
...
{
    int i;
   FILE *fp=fopen("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\allbookings.dat","rb");
   if(fp==NULL)
    return 0;
   Passenger pr;
   int count=0;
...
int book_ticket(Passenger p)
{
    ...
    FILE *fp=fopen("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\allbookings.dat","ab");
    if(fp==NULL)
    {
        textcolor(LIGHTRED);
...
{
    int result;
    FILE *fp1=fopen("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\allbookings.dat","rb");
    if(fp1==NULL)
    {
        textcolor(LIGHTRED);
    ...
    FILE *fp2=fopen("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\temp.dat","wb");
    Passenger pr;
    int found=0;
    while(fread(&pr,sizeof(pr),1,fp1)==1)
    {
        ...
        if(found==0)
        {
            remove("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\temp.dat");

        }
        else
        {
            result=remove("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\allbookings.dat");
            if(result!=0)
                return 2;
            result=rename("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\temp.dat","C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\allbookings.dat");
            if(result!=0)
                return 2;
        }
        return found;
...
int cancel_train(char* train_no)
{
    ...
    FILE *fp2=fopen("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\temp1.dat","wb");
    FILE *fp3=fopen("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\temp3.dat","wb");
    Train tr;
    Passenger pr;
    int found=0;
    int found1=0;
    ...
    if(found==0)
    {
        remove("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\temp1.dat");

    }
    else
    {
        result=remove("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\alltrains.dat");
        if(result!=0)
            return 2;
        result=rename("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\temp1.dat","C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\alltrains.dat");
        if(result!=0)
            return 2;
    }
    while(fread(&pr,sizeof(pr),1,fp1)==1)
    ...
    fclose(fp3);
    if(found1==0)
        remove("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\temp3.dat");
    else{
        result=remove("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\allbookings.dat");
        if(result!=0)
            return 2;
        result=rename("C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\temp3.dat","C:\\Users\\ANAND\\Desktop\\Codeblock\\rail file\\allbookings.dat");
        if(result!=0)
            return 2;
    }
    return found;
